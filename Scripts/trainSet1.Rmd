...
```{r site 3_4}
classified_3_4 <- predict_spatial(rast_3_4, trainSet1_lrn)
extract_3_4 <- extract(classified_3_4, pts_3_4)
className_3_4 <- extract_3_4[,2]
className_3_4_pts <- pts_3_4$className
vect_3_4 <- className_3_4 == className_3_4_pts
class_acc_3_4 <- sum(vect_3_4) / length(vect_3_4)
class_acc_3_4
# NA value is at row 2824
na_positions <- which(is.na(vect_3_4))
na_positions
# NA value is in className_3_4 (the classified raster)
value_className_3_4 <- className_3_4[2824]
value_className_3_4_pts <- className_3_4_pts[2824]
print(paste("Value from className_3_4:", value_className_3_4))
print(paste("Value from className_3_4_pts:", value_className_3_4_pts))

# the classified raster has GR as the className 
values <- classified_3_4[2824]
print(values_all_bands)

# the extracted value from the classified raster has NA className
row_2824 <- extract_3_4[2824, ]
print(row_2824)
```
```{r subset raster 3_4 and classify}
#subset the raster
xmin_original <- 316729.9
xmax_original <- 316759.8
ymin_original <- 5458770
ymax_original <- 5458795

buffer <- 2

xmin_cropped <- xmin_original + buffer
xmax_cropped <- xmax_original - buffer
ymin_cropped <- ymin_original + buffer
ymax_cropped <- ymax_original - buffer

e_cropped <- ext(316729.9 + 2, 316759.8 - 2, 5458770 + 2, 5458795 - 2)
r_cropped <- crop(rast_3_4, e_cropped)
r_classify <- predict_spatial(r_cropped, trainSet1_lrn)
na_mask <- is.na(r_classify)
na_cells <- which(na_mask[], arr.ind = TRUE)
```
